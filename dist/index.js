...
function DropdownMenu({ ...props }) {
    return jsxRuntime.jsx(DropdownMenuPrimitive__namespace.Root, { "data-slot": "dropdown-menu", ...props });
}
function DropdownMenuTrigger({ ...props }) {
    return (jsxRuntime.jsx(DropdownMenuPrimitive__namespace.Trigger, { "data-slot": "dropdown-menu-trigger", ...props }));
}
function DropdownMenuContent({ className, sideOffset = 4, ...props }) {
    ...
    return (jsxRuntime.jsx(DropdownMenuPrimitive__namespace.Portal, { container: portalContainer, children: jsxRuntime.jsx("div", { "data-workspace-menu-portal": "", style: { pointerEvents: 'auto' }, onClick: (e) => {
                // Prevent clicks from bubbling to parent app (Ant Design)
                e.stopPropagation();
            }, children: jsxRuntime.jsx(DropdownMenuPrimitive__namespace.Content, { "data-slot": "dropdown-menu-content", sideOffset: sideOffset, className: cn("bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 max-h-(--radix-dropdown-menu-content-available-height) min-w-[8rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-md border p-1 shadow-md", className), style: { zIndex: 2000 }, ...props }) }) }));
}
function DropdownMenuGroup({ ...props }) {
    return (jsxRuntime.jsx(DropdownMenuPrimitive__namespace.Group, { "data-slot": "dropdown-menu-group", ...props }));
}
...
function Dialog({ ...props }) {
    return jsxRuntime.jsx(DialogPrimitive__namespace.Root, { "data-slot": "dialog", ...props });
}
function DialogPortal({ ...props }) {
    return jsxRuntime.jsx(DialogPrimitive__namespace.Portal, { "data-slot": "dialog-portal", ...props });
}
function DialogOverlay({ className, ...props }) {
    return (jsxRuntime.jsx(DialogPrimitive__namespace.Overlay, { "data-slot": "dialog-overlay", className: cn("data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 bg-black/50", className), style: { zIndex: 2000 }, ...props }));
}
function DialogContent({ className, children, showCloseButton = true, ...props }) {
    ...
    return (jsxRuntime.jsx(DialogPortal, { container: portalContainer, "data-slot": "dialog-portal", children: jsxRuntime.jsxs("div", { "data-workspace-menu-portal": "", style: { pointerEvents: 'auto' }, onClick: (e) => {
                // Prevent clicks from bubbling to parent app (Ant Design)
                e.stopPropagation();
            }, children: [jsxRuntime.jsx(DialogOverlay, {}), jsxRuntime.jsxs(DialogPrimitive__namespace.Content, { "data-slot": "dialog-content", className: cn("bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border p-6 shadow-lg duration-200 sm:max-w-lg", className), style: { zIndex: 2001 }, ...props, children: [children, showCloseButton && (jsxRuntime.jsxs(DialogPrimitive__namespace.Close, { "data-slot": "dialog-close", className: "ring-offset-background focus:ring-ring data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4", children: [jsxRuntime.jsx(lucideReact.XIcon, {}), jsxRuntime.jsx("span", { className: "sr-only", children: "Close" })] }))] })] }) }));
}
function DialogHeader({ className, ...props }) {
    return (jsxRuntime.jsx("div", { "data-slot": "dialog-header", className: cn("flex flex-col gap-2 text-center sm:text-left", className), ...props }));
}
function DialogTitle({ className, ...props }) {
    return (jsxRuntime.jsx(DialogPrimitive__namespace.Title, { "data-slot": "dialog-title", className: cn("text-lg leading-none font-semibold", className), ...props }));
}
function DialogDescription({ className, ...props }) {
    return (jsxRuntime.jsx(DialogPrimitive__namespace.Description, { "data-slot": "dialog-description", className: cn("text-muted-foreground text-sm", className), ...props }));
}

function Card({ className, ...props }) {
    return (jsxRuntime.jsx("div", { "data-slot": "card", className: cn("bg-card text-card-foreground flex flex-col gap-6 rounded-xl border py-6 shadow-sm", className), ...props }));
}
...
const defaultQuickAccessApps = [
    ...
    },
    {
        ...
        icon: jsxRuntime.jsx(lucideReact.Handshake, { className: "w-4 h-4 text-[#a21caf]" }),
...
const Widget = ({ currentApp, quickAccessApps = defaultQuickAccessApps, fullApps = defaultFullApps, className = "", showAllServicesButton = true, }) => {
    ...
    return (jsxRuntime.jsxs("div", { className: "workspace-menu-root", onClick: (e) => {
            // Stop event propagation to prevent conflicts with parent app
            e.stopPropagation();
        }, children: [jsxRuntime.jsxs(DropdownMenu, { children: [jsxRuntime.jsx(DropdownMenuTrigger, { asChild: true, children: jsxRuntime.jsxs(Button, { variant: "outline", className: `w-full justify-between !px-4 !py-2.5 ${className}`, onClick: (e) => {
                                // Prevent default Ant Design behaviors
                                e.stopPropagation();
                            }, children: [jsxRuntime.jsxs("div", { className: "flex items-center gap-2", children: [jsxRuntime.jsx(lucideReact.LayoutGrid, { className: "w-4 h-4 text-[#5C60CC]" }), "IT \u0421\u0435\u0440\u0432\u0438\u0441\u044B"] }), jsxRuntime.jsx(lucideReact.ChevronsUpDown, { className: "w-4 h-4" })] }) }), jsxRuntime.jsx(DropdownMenuContent, { className: "w-56", align: "start", children: jsxRuntime.jsxs(DropdownMenuGroup, { children: [quickAccessApps
                                    .filter((app) => app.id !== currentApp) // Убираем текущее приложение
                                    .map((app) => (jsxRuntime.jsxs(DropdownMenuItem, { onClick: (e) => {
                                        e.stopPropagation();
                                        handleQuickAppClick(app);
                                    }, disabled: !app.url, children: [app.icon, app.title] }, app.id))), showAllServicesButton && (jsxRuntime.jsxs(DropdownMenuItem, { className: "justify-between items-center", onClick: (e) => {
                                        e.stopPropagation();
                                        handleAllServicesClick();
                                    }, children: [jsxRuntime.jsxs("div", { className: "flex items-center gap-2", children: [jsxRuntime.jsx(lucideReact.LayoutGrid, { className: "w-4 h-4" }), "\u0412\u0441\u0435 \u0441\u0435\u0440\u0432\u0438\u0441\u044B"] }), jsxRuntime.jsx(lucideReact.ChevronRight, { className: "w-4 h-4 text-[#3F3F46]" })] }))] }) })] }), jsxRuntime.jsx(Dialog, { open: isAppsModalOpen, onOpenChange: setIsAppsModalOpen, children: jsxRuntime.jsxs(DialogContent, { className: "overflow-y-auto p-6", style: {
                        maxWidth: "calc(100vw - 240px)",
                        maxHeight: "95vh",
                    }, children: [jsxRuntime.jsx(DialogHeader, { className: "h-fit", children: jsxRuntime.jsx(DialogTitle, { className: "text-xl font-semibold", children: "\u0421\u043F\u0438\u0441\u043E\u043A \u0432\u0441\u0435\u0445 \u0434\u043E\u0441\u0442\u0443\u043F\u043D\u044B\u0445 \u043F\u0440\u0438\u043B\u043E\u0436\u0435\u043D\u0438\u0439" }) }), jsxRuntime.jsx("div", { className: "grid grid-cols-3 gap-4 mt-6", children: fullApps
                                .filter((app) => app.id !== currentApp) // Убираем текущее приложение
                                ...
                                }, children: jsxRuntime.jsxs(CardContent, { className: "p-4", children: [jsxRuntime.jsxs("div", { className: "flex items-start justify-between mb-3 relative", children: [jsxRuntime.jsxs("div", { className: "flex items-center gap-3 relative", children: [jsxRuntime.jsx("div", { className: "z-10", children: app.icon }), jsxRuntime.jsx("div", { className: `absolute top-2 left-4 w-6 h-7 rounded-[3px] ${app.iconBg} z-0` })] }), app.url && (jsxRuntime.jsx(Button, { variant: "ghost", size: "icon", className: "p-0 cursor-pointer", onClick: (e) => {
                                                        e.stopPropagation();
