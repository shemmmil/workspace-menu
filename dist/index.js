...
const BarChart3 = ({ className, ...props }) => (jsxRuntime.jsxs("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: className, ...props, children: [jsxRuntime.jsx("path", { d: "M3 3v18h18" }), jsxRuntime.jsx("path", { d: "M18 17V9" }), jsxRuntime.jsx("path", { d: "M13 17V5" }), jsxRuntime.jsx("path", { d: "M8 17v-3" })] }));
const Brain = ({ className, ...props }) => (jsxRuntime.jsxs("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: className, ...props, children: [jsxRuntime.jsx("path", { d: "M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.96-3.08 3 3 0 0 1-.34-5.58 2.5 2.5 0 0 1 1.32-4.24 2.5 2.5 0 0 1 1.98-3A2.5 2.5 0 0 1 9.5 2Z" }), jsxRuntime.jsx("path", { d: "M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.96-3.08 3 3 0 0 0 .34-5.58 2.5 2.5 0 0 0-1.32-4.24 2.5 2.5 0 0 0-1.98-3A2.5 2.5 0 0 0 14.5 2Z" })] }));
...
const Headphones = ({ className, ...props }) => (jsxRuntime.jsx("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: className, ...props, children: jsxRuntime.jsx("path", { d: "M3 14h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-7a9 9 0 0 1 18 0v7a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3" }) }));
...
const ExternalLink = ({ className, ...props }) => (jsxRuntime.jsxs("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: className, ...props, children: [jsxRuntime.jsx("path", { d: "M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" }), jsxRuntime.jsx("polyline", { points: "15 3 21 3 21 9" }), jsxRuntime.jsx("line", { x1: "10", y1: "14", x2: "21", y2: "3" })] }));
...
const DropdownMenu = ({ children }) => {
    ...
    return (jsxRuntime.jsx(DropdownMenuContext.Provider, { value: { open, onOpenChange: setOpen }, children: jsxRuntime.jsx("div", { className: styles$3.dropdownMenu, "data-slot": "dropdown-menu", children: children }) }));
};
const DropdownMenuTrigger = ({ asChild, children }) => {
    ...
    return (jsxRuntime.jsx("button", { "data-slot": "dropdown-menu-trigger", className: styles$3.trigger, onClick: handleClick, children: children }));
};
...
const DropdownMenuContent = React.forwardRef(({ className = "", children, align = "start", side = "bottom", sideOffset = 4, ...props }, ref) => {
    ...
    if (!context?.open)
        return null;
    return (jsxRuntime.jsx(DropdownMenuPortal, { children: jsxRuntime.jsx("div", { ref: contentRef, "data-slot": "dropdown-menu-content", "data-side": side, "data-align": align, className: `${styles$3.content} ${closing ? styles$3.closing : ""} ${className}`, style: position ? { position: "fixed", top: `${position.top}px`, left: `${position.left}px` } : {}, ...props, children: children }) }));
});
...
const Widget = ({ currentApp, quickAccessApps = defaultQuickAccessApps, fullApps = defaultFullApps, className = "", showAllServicesButton = true, }) => {
    ...
    return (jsxRuntime.jsxs("div", { className: styles.root, children: [jsxRuntime.jsxs(DropdownMenu, { children: [jsxRuntime.jsx(DropdownMenuTrigger, { asChild: true, children: jsxRuntime.jsxs(Button, { variant: "outline", className: `${styles.triggerButton} ${className}`, children: [jsxRuntime.jsxs("div", { className: styles.triggerContent, children: [jsxRuntime.jsx(LayoutGrid, { className: styles.iconBrand }), "IT \u0421\u0435\u0440\u0432\u0438\u0441\u044B"] }), jsxRuntime.jsx(ChevronsUpDown, { className: styles.iconSmall })] }) }), jsxRuntime.jsx(DropdownMenuContent, { className: styles.dropdownContent, align: "start", children: jsxRuntime.jsxs(DropdownMenuGroup, { children: [quickAccessApps
                        ...
                        maxHeight: "95vh",
                                ...
                                .filter((app) => app.id !== currentApp)
                                .map((app) => (jsxRuntime.jsx(Card, { className: app.url ? styles.cardClickable : "", onClick: () => app.url && handleFullAppClick(app), children: jsxRuntime.jsxs(CardContent, { className: styles.cardContent, children: [jsxRuntime.jsxs("div", { className: styles.cardHeader, children: [jsxRuntime.jsxs("div", { className: styles.iconWrapper, children: [jsxRuntime.jsx("div", { className: styles.iconContainer, children: app.icon }), jsxRuntime.jsx("div", { className: `${styles.iconBg} ${app.iconBg}` })] }), app.url && (jsxRuntime.jsx(Button, { variant: "ghost", size: "icon", className: styles.externalLinkButton, onClick: (e) => {
                                                        e.stopPropagation();
                                                        handleFullAppClick(app);
                                                    }, children: jsxRuntime.jsx(ExternalLink, { className: styles.iconSmall }) }))] }), jsxRuntime.jsx("h3", { className: styles.appTitle, children: app.title }), jsxRuntime.jsx("p", { className: styles.appDescription, children: app.description })] }) }, app.id))) })] }) })] }));
};
