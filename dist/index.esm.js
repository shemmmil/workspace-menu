...
import { XIcon, BarChart3, Handshake, Brain, Headphones, Mail, Newspaper, HandMetal, FileCheck2, PencilRuler, LayoutGrid, ChevronsUpDown, ChevronRight, ExternalLink } from 'lucide-react';
...
function DropdownMenuContent({ className, sideOffset = 4, ...props }) {
    ...
    return (jsx(DropdownMenuPrimitive.Portal, { container: portalContainer, children: jsx("div", { "data-workspace-menu-portal": "", style: { pointerEvents: 'auto' }, onClick: (e) => {
...
function DialogOverlay({ className, ...props }) {
    return (jsx(DialogPrimitive.Overlay, { "data-slot": "dialog-overlay", className: cn("data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 bg-black/50", className), style: { zIndex: 2000 }, ...props }));
}
...
const defaultQuickAccessApps = [
    ...
    },
    {
        ...
        icon: jsx(Handshake, { className: "w-4 h-4 text-[#a21caf]" }),
...
const Widget = ({ currentApp, quickAccessApps = defaultQuickAccessApps, fullApps = defaultFullApps, className = "", showAllServicesButton = true, }) => {
    ...
    return (jsxs("div", { className: "workspace-menu-root", onClick: (e) => {
            // Stop event propagation to prevent conflicts with parent app
            e.stopPropagation();
        }, children: [jsxs(DropdownMenu, { children: [jsx(DropdownMenuTrigger, { asChild: true, children: jsxs(Button, { variant: "outline", className: `w-full justify-between !px-4 !py-2.5 ${className}`, onClick: (e) => {
                                // Prevent default Ant Design behaviors
                                e.stopPropagation();
                            }, children: [jsxs("div", { className: "flex items-center gap-2", children: [jsx(LayoutGrid, { className: "w-4 h-4 text-[#5C60CC]" }), "IT \u0421\u0435\u0440\u0432\u0438\u0441\u044B"] }), jsx(ChevronsUpDown, { className: "w-4 h-4" })] }) }), jsx(DropdownMenuContent, { className: "w-56", align: "start", children: jsxs(DropdownMenuGroup, { children: [quickAccessApps
                                    .filter((app) => app.id !== currentApp) // Убираем текущее приложение
                                    .map((app) => (jsxs(DropdownMenuItem, { onClick: (e) => {
                                        e.stopPropagation();
                                        handleQuickAppClick(app);
                                    }, disabled: !app.url, children: [app.icon, app.title] }, app.id))), showAllServicesButton && (jsxs(DropdownMenuItem, { className: "justify-between items-center", onClick: (e) => {
                                        e.stopPropagation();
                                        handleAllServicesClick();
                                    }, children: [jsxs("div", { className: "flex items-center gap-2", children: [jsx(LayoutGrid, { className: "w-4 h-4" }), "\u0412\u0441\u0435 \u0441\u0435\u0440\u0432\u0438\u0441\u044B"] }), jsx(ChevronRight, { className: "w-4 h-4 text-[#3F3F46]" })] }))] }) })] }), jsx(Dialog, { open: isAppsModalOpen, onOpenChange: setIsAppsModalOpen, children: jsxs(DialogContent, { className: "overflow-y-auto p-6", style: {
                        maxWidth: "calc(100vw - 240px)",
                        maxHeight: "95vh",
                    }, children: [jsx(DialogHeader, { className: "h-fit", children: jsx(DialogTitle, { className: "text-xl font-semibold", children: "\u0421\u043F\u0438\u0441\u043E\u043A \u0432\u0441\u0435\u0445 \u0434\u043E\u0441\u0442\u0443\u043F\u043D\u044B\u0445 \u043F\u0440\u0438\u043B\u043E\u0436\u0435\u043D\u0438\u0439" }) }), jsx("div", { className: "grid grid-cols-3 gap-4 mt-6", children: fullApps
                                .filter((app) => app.id !== currentApp) // Убираем текущее приложение
